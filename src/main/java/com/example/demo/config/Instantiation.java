...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa viagem mano!", sdf.parse("21/02/2019"), new AuthorDTO(alex));
        CommentDTO c2 = new CommentDTO("Aproveite!", sdf.parse("21/02/2018"), new AuthorDTO(bob));
        CommentDTO c3 = new CommentDTO("Tenha um otimo dia!", sdf.parse("21/055/2020"), new AuthorDTO(alex));
